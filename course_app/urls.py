...
from .views import video_page, slayd_page, maruza_page, amaliy_page, test_page, \
    download_maruza, download_amaliy, download_taqdimot, labaratoriya_page, download_labaratoriya
...
urlpatterns = [
    ...
    path('labaratoriya/', labaratoriya_page, name='labaratoriya_page'),
    ...
    path('download-labaratoriya/<int:pk>/', download_labaratoriya, name='download_labaratoriya'),
]
